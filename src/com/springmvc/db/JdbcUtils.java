...
public class JdbcUtils {
    ...
    public static void beginTransaction() throws SQLException {
        //获取当前线程的事物连接
        Connection connection = threadLocal.get();
        if (connection == null) throw new SQLException("已经开启了事物，不能重复开启！");
    ...
    public static void commitTransaction() throws SQLException {
        Connection connection = threadLocal.get();
        if (connection == null) throw new SQLException("没有事务，不能提交！");
        connection.commit();
        connection.close();
    ...
    public static void rollback(Connection connection) throws SQLException {
        ...
        if (connection == null)throw new SQLException("没有事务，不能回滚！");
        connection.rollback();
        connection.close();
        connection = null;
        threadLocal.remove();
